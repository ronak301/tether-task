...
A non-custodial Ethereum wallet built on the WDK (Wallet Development Kit)
starter kit. Supports wallet creation, import, multi-wallet switching, USDT /
XAUt / ETH balances, send, receive, and transaction history — all on Sepolia
testnet.

## Demo

[![Demo](assets/docs/demo-thumbnail.png)](assets/docs/demo.mp4)
...
- **[SUBMISSION.md](SUBMISSION.md)** — what's implemented, known callouts,
  platform notes
- **[ARCHITECTURE.md](ARCHITECTURE.md)** — SDK boundary, folder structure, state
  and auth patterns
